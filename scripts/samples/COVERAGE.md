...
**PcbLib:** a region's non-default `SUBPOLYINDEX` — 🚫 for scripts, since `SubPolyIndex` is
an undeclared identifier on `IPCB_Region` in AD24; `CAVITYHEIGHT` is ✅ covered by
