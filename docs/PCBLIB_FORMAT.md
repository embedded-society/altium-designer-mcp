...
Established by `manual/thermal_relief.PcbLib`, six pads that each change one or two settings:
...
| 222-225 | 4 | Min Distance (i32; 15 mil in every sample) | `min_distance` |
| 226-227 | 2 | Reserved (`0`) | replayed |
